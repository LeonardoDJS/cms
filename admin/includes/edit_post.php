...
<form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input value="<?php echo $post_author; ?>" type="text" class="form-control" 
                    name="post_author">
                </div>
                <div class="form-group">
...
$query = "UPDATE posts SET post_title = '{$the_post_title}' WHERE post_category_id = 
{$post_id }";
...
if(isset($_GET['edit'])){ 
    ...
    $post_id = $_GET['edit'];
    $query = "SELECT * FROM posts  WHERE post__category_id = $post_id";
